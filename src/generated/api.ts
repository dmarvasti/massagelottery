...
export const AdminsApiFetchParamCreator = {
     ...
     */
    executeLottery(params: {  "lottery"?: Lottery1; }, options?: any): FetchArgs {
        const baseUrl = `/lottery/`;
        let urlObj = url.parse(baseUrl, true);
...
export const AdminsApiFp = {
     ...
     * @param lottery true to select, false to deselect. will overwrite previous selection
     */
    executeLottery(params: { "lottery"?: Lottery1;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
...
export class AdminsApi extends BaseAPI {
     ...
     * @param lottery true to select, false to deselect. will overwrite previous selection
     */
    executeLottery(params: {  "lottery"?: Lottery1; }, options?: any) {
